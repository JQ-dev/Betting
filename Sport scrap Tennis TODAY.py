        ...
        while df1.shape[0] == 0 or count > 5: 
            ...
            for small_box in big_box:
                ...
                try:            
                    ...
                    odds_dict['url'] = 'N/D'     
                try:            
                    odds_dict['live_score'] = small_box.find('td', attrs={'class': 'table-score table-odds live-score center bold' }).find('span')['xparam']
                except:
                    odds_dict['live_score'] = 'N/D'                   
                try:            
